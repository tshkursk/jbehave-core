...
public class StepsBehaviour {
    ...
    private void performMatchedStep(List<StepCandidate> candidates, String candidateAsString, String stepAsString) {
        ...
        findCandidate(candidates, candidateAsString).createMatchedStep(stepAsString, tableRow).perform(reporter, null);
    ...
    public void shouldFailIfDuplicateStepsAreEncountered() {
        ...
        candidates.get(0).createMatchedStep("Given a given", tableRow).perform(null, null);
